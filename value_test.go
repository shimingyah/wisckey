...
func TestChecksums(t *testing.T) {
	...
	// The vlog should contain K0 and K3 (K1 and k2 was lost when Wisckey started up
...
func TestPartialAppendToValueLog(t *testing.T) {
	...
	// Replay value log from beginning, wisckey head is past k2.
...
func TestReadOnlyOpenWithPartialAppendToValueLog(t *testing.T) {
	...
	opts.ReadOnly = true
	// Wisckey should fail a read-only open with values to replay
	kv, err = Open(opts)
	require.Error(t, err)
