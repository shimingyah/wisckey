...
func init() {
	NumReads = expvar.NewInt("wisckey_disk_reads_total")
	NumWrites = expvar.NewInt("wisckey_disk_writes_total")
	NumBytesRead = expvar.NewInt("wisckey_read_bytes")
	NumBytesWritten = expvar.NewInt("wisckey_written_bytes")
	NumLSMGets = expvar.NewMap("wisckey_lsm_level_gets_total")
	NumLSMBloomHits = expvar.NewMap("wisckey_lsm_bloom_hits_total")
	NumGets = expvar.NewInt("wisckey_gets_total")
	NumPuts = expvar.NewInt("wisckey_puts_total")
	NumBlockedPuts = expvar.NewInt("wisckey_blocked_puts_total")
	NumMemtableGets = expvar.NewInt("wisckey_memtable_gets_total")
	LSMSize = expvar.NewMap("wisckey_lsm_size_bytes")
	VlogSize = expvar.NewMap("wisckey_vlog_size_bytes")
	PendingWrites = expvar.NewMap("wisckey_pending_writes_total")
}
