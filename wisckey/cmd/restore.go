...
var restoreCmd = &cobra.Command{
	Use:   "restore",
	Short: "Restore Wisckey database.",
	Long: `Restore Wisckey database from a file.
...
func init() {
	...
	restoreCmd.Flags().StringVarP(&restoreFile, "backup-file", "f",
		"wisckey.bak", "File to restore from")
...
func doRestore(cmd *cobra.Command, args []string) error {
	...
	manifestFile := path.Join(sstDir, wisckey.ManifestFilename)
