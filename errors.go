...
var (
	...
	// ErrInvalidKey is returned if the key has a special !wisckey! prefix,
	// reserved for internal usage.
	ErrInvalidKey = errors.New("Key is using a reserved !wisckey! prefix")
	...
	// corrupt data to allow Wisckey to run properly.
	ErrTruncateNeeded = errors.New("Value log truncate required to run DB. This might result in data loss")

	// ErrBlockedWrites is returned if the user called DropAll. During the process of dropping all
	// data from Wisckey, we stop accepting new writes, by returning this error.
