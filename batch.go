...
// creating and committing transactions. Due to the nature of SSI guaratees provided by wisckey,
...
// Flush must be called at the end to ensure that any pending writes get committed to wisckey. Flush
